...
const FeatureSection = ({
    ...
    return (
        <div
            className={`flex  items-center max-lg:justify-center max-lg:text-center flex-col lg:flex-row xl:gap-[203.5px] lg:gap-9 md:gap-20 sm:gap-20 gap-[39.56px]   ${reverse ? "lg:flex-row-reverse " : ""}`}
        >
