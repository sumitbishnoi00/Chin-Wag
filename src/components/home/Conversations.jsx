        ...
        <div className="grid md:grid-cols-2 lg:gap-10 md:gap-8.5 sm:gap-7 gap-5.75">
          {CONVERSATIONS_DATA.map((item, index) => (
            ...
            >
              ...
              <button className="md:py-[15.5px] py-3.25 w-full lg:px-21.25 md:px-15 sm:px-10 px-[23.5px] border border-none rounded-[138px] font-bold lg:text-16 md:text-14 sm:text-13 text-12 leading-131 text-charcoal-green bg-pale-aqua group-hover:text-white group-hover:bg-storm-gray transition-all duration-500 cursor-pointer">
                {item.btn}
              </button>
            </div>
          ))}
