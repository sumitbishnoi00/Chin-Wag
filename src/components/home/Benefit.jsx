...
const Benefit = () => {
  return (
    <section className=' relative px-9.5 md:px-4 pt-[71.87px] sm:pt-20 md:pt-30 lg:pt-40'>
      <Image src={"/assets/images/webg/benefit-left.webp"} width={66.6} height={78} alt='benefit-left' className=' absolute left-19 top-50 animate-benefit-left' />
      <Image src={"/assets/images/webg/benefit-right.webp"} width={74} height={74} alt='benefit-right' className=' absolute right-11 bottom-0 animate-benefit-right' />
